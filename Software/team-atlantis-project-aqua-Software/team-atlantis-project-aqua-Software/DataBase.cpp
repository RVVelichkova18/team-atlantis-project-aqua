...
void insertBird(nanodbc::connection conn, string ability, string name, string color, string size, string yersoflife, string migration, string sizeofeggs)
{
    ...
    statement.bind(4, yersoflife.c_str());//(int*)yersoflife);
